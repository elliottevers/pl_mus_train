...
(function (window) {
    ...
    var red = [255, 0, 0];
    var black = [0, 0, 0];
    var PwindowTree = /** @class */ (function () {
        function PwindowTree(height, width, messenger
        ...
        PwindowTree.prototype.render = function () {
            var messages_regions = this.get_messages_regions();
            ...
            for (var _i = 0, messages_regions_1 = messages_regions; _i < messages_regions_1.length; _i++) {
                var message = messages_regions_1[_i];
            ...
            for (var _a = 0, messages_notes_1 = messages_notes; _a < messages_notes_1.length; _a++) {
                var message = messages_notes_1[_a];
                message.unshift('render');
                this.messenger.message(message);
            }
            for (var _b = 0, messages_tree_1 = messages_tree; _b < messages_tree_1.length; _b++) {
                var message = messages_tree_1[_b];
                message.unshift('render');
                this.messenger.message(message);
            }
        };
        ...
        //     return this.leaves;
        // }
        PwindowTree.prototype.insert = function (notes) {
        ...
        PwindowTree.prototype.set_root = function (note_root) {
        ...
        // }
        PwindowTree.prototype.splice_notes = function (notes_subset, clip, interval_beats) {
        ...
        PwindowTree.prototype.get_note_index_at_beat = function (beat, notes) {
            var val = _.findIndex(notes, function (node) {
                return node.model.note.beat_start === beat;
            });
            return val;
        };
        PwindowTree.prototype.get_leaves_within_interval = function (beat_start, beat_end) {
        ...
        PwindowTree.prototype.get_num_measures_clip = function () {
            return this.clips[0].get_num_measures();
        };
        // TODO: make node have indices to both clip and note
        PwindowTree.prototype.get_centroid = function (node) {
        ...
        PwindowTree.prototype.get_order_of_note_at_beat_start = function (notes, beat_start) {
            return _.findIndex(notes, function (node) {
                return node.model.note.beat_start === beat_start;
            });
        };
        PwindowTree.prototype.get_order_of_note_at_beat_end = function (notes, beat_end) {
            return _.findIndex(notes, function (node) {
                return node.model.note.get_beat_end() === beat_end;
            });
        };
        PwindowTree.prototype.get_interval_beats = function (notes) {
            return [
        ...
        PwindowTree.prototype.add_clip = function (clip) {
            this.clips.push(clip);
        };
        ;
        PwindowTree.prototype.get_diff_index_start = function (notes_new, notes_old) {
        ...
        PwindowTree.prototype.get_diff_index_end = function (notes_new, notes_old) {
        ...
        PwindowTree.prototype.get_diff_index_notes = function (notes_parent, notes_child) {
            return [
        ...
        ;
        PwindowTree.prototype.render_tree = function () {
        ...
        PwindowTree.prototype.get_messages_render_tree = function () {
            var _this = this;
        ...
        ;
        PwindowTree.prototype.add_first_layer = function (notes, index_new_layer) {
        ...
        PwindowTree.prototype.add_layer = function (notes_parent, notes_child, index_new_layer) {
            var note_parent_best, b_successful;
        ...
        ;
        PwindowTree.prototype.update_leaves = function (leaves) {
        ...
        PwindowTree.prototype.render_clips = function () {
        ...
        PwindowTree.prototype.get_messages_render_clips = function () {
            var messages = [];
        ...
        ;
        PwindowTree.prototype.get_messages_render_notes = function (index_clip) {
        ...
        ;
        PwindowTree.prototype.get_position_quadruplet = function (node, index_clip) {
        ...
        ;
        PwindowTree.prototype.get_dist_from_top = function (pitch, index_clip) {
            var clip = this.clips[index_clip];
        ...
        ;
        PwindowTree.prototype.get_dist_from_left = function (beat) {
            return this.beat_to_pixel(beat);
        };
        ;
        PwindowTree.prototype.get_height_clip = function () {
            return this.height / this.clips.length;
        };
        ;
        PwindowTree.prototype.get_height_note = function (index_clip) {
            var ambitus = this.get_ambitus(index_clip);
            var dist_pitch = ambitus[1] - ambitus[0] + 1;
            return this.get_height_clip() / dist_pitch;
        };
        ;
        PwindowTree.prototype.get_ambitus = function (index_clip) {
            return this.clips[index_clip].get_ambitus();
        };
        ;
        return PwindowTree;
    }());
    window.PwindowTree = PwindowTree;
})(window = exports.window || (exports.window = {}));
//# sourceMappingURL=tree_window.js.map