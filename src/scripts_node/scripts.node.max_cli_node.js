...
var executable_youtube_dl = new cli_1.cli.Executable('/usr/local/bin/youtube-dl', [flag_audio_only], [option_outfile, option_format], [arg_url]);
var run = function () {
...
//     // path_script = path;
// };
shell.exec(executable_youtube_dl.get_command_full().join(' '), { silent: true });
// console.log(version);
