...
var main = function () {
    post('working');
    // clip 1
    var clip_dao_1 = new clip_5.clip.ClipDao(15, 0, new messenger_1.message.Messenger('max', 0), false);
    ...
    // });
    // clip 2
    var clip_dao_2 = new clip_5.clip.ClipDao(14, 0, new messenger_1.message.Messenger('max', 0), false);
    ...
    // });
    // clip 3
    var clip_dao_3 = new clip_5.clip.ClipDao(13, 0, new messenger_1.message.Messenger('max', 0), false);
    ...
    // });
    // clip 4
    var clip_dao_4 = new clip_5.clip.ClipDao(12, 0, new messenger_1.message.Messenger('max', 0), false);
...
var b_export_object_to_global_object = (env !== 'node'); // implies max
// NB: define object and its interface
// if (b_export_object_to_global_object && typeof Global !== undefined) {
if (b_export_object_to_global_object) {
    Global.renderer = {};
