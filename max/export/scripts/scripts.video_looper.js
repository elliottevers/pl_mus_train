...
var name_objects_patcher;
(function (name_objects_patcher) {
    name_objects_patcher.JIT_MOVIE = 'jit_movie';
})(name_objects_patcher = exports.name_objects_patcher || (exports.name_objects_patcher = {}));
...
var video = new Video('/Users/elliottevers/Downloads/white-t-shirt.mp4', patcher);
// video.load();
//
...
},{"../message/messenger":2,"../video/video":4}],4:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
...
var video;
(function (video) {
    var JIT_MOVIE = constants_1.name_objects_patcher.JIT_MOVIE;
    var Video = /** @class */ (function () {
        function Video(path_file, patcher) {
            this.path_file = path_file;
            this.patcher = patcher;
        }
        Video.prototype.get_length = function () {
    ...
    var Looper = /** @class */ (function () {
        ...
        Looper.prototype.set_beat_estimates = function (estimates_beat_position_percentile) {
            this.beat_estimates = estimates_beat_position_percentile;
        };
        Looper.prototype.beats_to_bars = function (beats) {
            var bars = [];
            for (var i_point in beats) {
                if (parseInt(i_point) % 4 == 0) {
        ...
        Looper.prototype.get_bar = function () {
            return this.beat_estimates;
        };
        // create rightmost cut from current playback time
        Looper.prototype.add_cut = function () {
        };
        Looper.prototype.update_cuts_from_loop = function (frame_loop_start, frame_loop_end) {
...
},{"../constants/constants":1,"underscore":5}],5:[function(require,module,exports){
(function (global){
//     Underscore.js 1.9.1
