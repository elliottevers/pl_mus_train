...
var append_note = function (pitch, beat_start, beats_duration, velocity, b_muted) {
    var tree = new TreeModel();
    var note_parsed = tree.parse({
        id: -1,
        note: new note_1.note.Note(pitch, beat_start, beats_duration, velocity, b_muted),
        children: []
    });
...
},{"../clip/clip":1,"../live/live":2,"../message/messenger":3,"../note/note":4,"tree-model":9}],6:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
var utils;
(function (utils) {
...
var clear_notes = Global.note_setter.clear_notes;
var append_note = Global.note_setter.append_note;
var set_notes = Global.note_setter.set_notes;